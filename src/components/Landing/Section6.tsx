            ...
            >
              ...
              >
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="px-6 py-3 sm:px-8 sm:py-4 bg-white/50 backdrop-blur-sm border border-gray-200/50 text-gray-700 font-semibold rounded-xl hover:bg-white/70 transition-all duration-300 flex items-center justify-center gap-3 group"
                >
