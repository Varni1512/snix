...
import social from '/aishoot/socialmedia.png'
import catalogue from '/aishoot/catalogue.png'
import editorial from '/aishoot/editorial.png'
import accesories from '/aishoot/accesories.png'
            ...
            <section className="relative px-4 py-20 md:py-32">
                ...
                <div className="max-w-7xl mx-auto text-center">
                    <div className={`transform transition-all duration-1000 ${isVisible.hero ? 'translate-y-0 opacity-100' : 'translate-y-12 opacity-0'}`} id="hero">
                        ...
                        <p className="text-lg md:text-xl text-gray-500 mb-14 mx-auto">
